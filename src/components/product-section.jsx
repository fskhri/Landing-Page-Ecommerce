        ...
        <div className="pt-6">
          ...
          <div className="mt-3 py-3 px-4 flex justify-center rounded-lg shadow-lg">
            <div className="flex flex-wrap justify-center gap-3">
              <button className={`py-2 px-4 ${selectedBrand === 1 ? 'bg-blue-400 text-white' : 'bg-transparent border-2 border-blue-400 text-blue-400'} rounded`} onClick={() => setSelectedBrand(1)}>VIVO</button>
              <button className={`py-2 px-4 ${selectedBrand === 2 ? 'bg-blue-400 text-white' : 'bg-transparent border-2 border-blue-400 text-blue-400'} rounded hover:bg-blue-400 hover:text-white`} onClick={() => setSelectedBrand(2)}>OPPO</button>
              <button className={`py-2 px-4 ${selectedBrand === 3 ? 'bg-blue-400 text-white' : 'bg-transparent border-2 border-blue-400 text-blue-400'} rounded hover:bg-blue-400 hover:text-white`} onClick={() => setSelectedBrand(3)}>SAMSUNG</button>
              <button className={`py-2 px-4 ${selectedBrand === 4 ? 'bg-blue-400 text-white' : 'bg-transparent border-2 border-blue-400 text-blue-400'} rounded hover:bg-blue-400 hover:text-white`} onClick={() => setSelectedBrand(4)}>REDMI</button>
              <button className={`py-2 px-4 ${selectedBrand === 5 ? 'bg-blue-400 text-white' : 'bg-transparent border-2 border-blue-400 text-blue-400'} rounded hover:bg-blue-400 hover:text-white`} onClick={() => setSelectedBrand(5)}>REALME</button>
              <button className={`py-2 px-4 ${selectedBrand === 6 ? 'bg-blue-400 text-white' : 'bg-transparent border-2 border-blue-400 text-blue-400'} rounded hover:bg-blue-400 hover:text-white`} onClick={() => setSelectedBrand(6)}>INFINIX</button>
            </div>
          </div>
